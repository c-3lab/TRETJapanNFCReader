...
var apduUserAuthenticationPin:String = Bundle.main.object(forInfoDictionaryKey: "userAuthenticationPin") as! String
var apduUserAuthenticationPrivate:String = Bundle.main.object(forInfoDictionaryKey: "userAuthenticationPrivate") as! String
var apduUserAuthenticationCertificate:String = Bundle.main.object(forInfoDictionaryKey: "userAuthenticationCertificate") as! String
var apduDigitalSignaturePin:String = Bundle.main.object(forInfoDictionaryKey: "digitalSignaturePin") as! String
var apduDigitalSignaturePrivate:String = Bundle.main.object(forInfoDictionaryKey: "digitalSignaturePrivate") as! String
var apduDigitalSignatureCertificate:String = Bundle.main.object(forInfoDictionaryKey: "digitalSignatureCertificate") as! String
...
extension IndividualNumberReader {
    ...
    internal func computeDigitalSignatureForUserAuthentication(_ session: NFCTagReaderSession, _ individualNumberCard: IndividualNumberCard, userAuthenticationPIN: [UInt8], dataToSign: [UInt8]) -> IndividualNumberCard {
        ...
        self.selectJPKIAP(tag: tag){ (responseData, sw1, sw2, error) in
            ...
            let userAuthenticationPin = self.getHexNum(hexString: apduUserAuthenticationPin)
            self.selectEF(tag: tag, data: [userAuthenticationPin.upper, userAuthenticationPin.lower]) { (responseData, sw1, sw2, error) in
                // 認証用PINを選択する
                self.printData(responseData, sw1, sw2)
                ...
                self.verify(tag: tag, pin: userAuthenticationPIN) { (responseData, sw1, sw2, error) in
                    ...
                    let userAuthenticationPrivate = self.getHexNum(hexString: apduUserAuthenticationPrivate)
                    self.selectEF(tag: tag, data: [userAuthenticationPrivate.upper, userAuthenticationPrivate.lower]) { (responseData, sw1, sw2, error) in
                        // 認証用秘密鍵を選択する
                        self.printData(responseData, sw1, sw2)
    ...
    internal func getDigitalCertificateForUserVerification(_ session: NFCTagReaderSession,_ individualNumberCard: IndividualNumberCard)-> IndividualNumberCard{
        ...
        self.selectJPKIAP(tag: tag){ (responseData, sw1, sw2, error) in
            ...
            let userAuthenticationCertificate = self.getHexNum(hexString: apduUserAuthenticationCertificate)
            self.selectEF(tag: tag, data: [userAuthenticationCertificate.upper, userAuthenticationCertificate.lower]) { (responseData, sw1, sw2, error) in
                // 公的個人認証用証明書を選択する
                self.printData(responseData, sw1, sw2)
    ...
    internal func computeDigitalSignatureForDigitalSignature(_ session: NFCTagReaderSession, _ individualNumberCard: IndividualNumberCard, digitalSignaturePIN: [UInt8], dataToSign: [UInt8]) -> IndividualNumberCard {
        ...
        self.selectJPKIAP(tag: tag){ (responseData, sw1, sw2, error) in
            ...
            let digitalSignaturePin = self.getHexNum(hexString: apduDigitalSignaturePin)
            self.selectEF(tag: tag, data: [digitalSignaturePin.upper, digitalSignaturePin.lower]) { (responseData, sw1, sw2, error) in
                // 認証用PINを選択する
                self.printData(responseData, sw1, sw2)
                ...
                self.verify(tag: tag, pin: digitalSignaturePIN) { (responseData, sw1, sw2, error) in
                    ...
                    let digitalSignaturePrivate = self.getHexNum(hexString: apduDigitalSignaturePrivate)
                    self.selectEF(tag: tag, data: [digitalSignaturePrivate.upper, digitalSignaturePrivate.lower]) { (responseData, sw1, sw2, error) in
                        // 認証用秘密鍵を選択する
                        self.printData(responseData, sw1, sw2)
        ...
        self.selectJPKIAP(tag: tag){ (responseData, sw1, sw2, error) in
            ...
            self.selectEF(tag: tag, data: [digitalSignaturePin.upper, digitalSignaturePin.lower]) { (responseData, sw1, sw2, error) in
                ...
                self.verify(tag: tag, pin: digitalSignaturePIN) { (responseData, sw1, sw2, error) in
                    ...
                    // 署名用証明書を読みこむ
                    let digitalSignatureCertificate = self.getHexNum(hexString: apduDigitalSignatureCertificate)
                    self.selectEF(tag: tag, data: [digitalSignatureCertificate.upper, digitalSignatureCertificate.lower]) { (responseData, sw1, sw2, error) in
                        // 公的個人認証用証明書を選択する
                        self.printData(responseData, sw1, sw2)
    ...
    private func generateDigestInfo(data : [UInt8]) -> [UInt8]{
    ...
    private func getSizeIntByResposeData(responseData : Data) -> Int{
    ...
    private func getSizeArrayByResposeData(responseData : Data) -> [UInt8]{
        let responseDataArray : [UInt8] = [UInt8](responseData)
        return [responseDataArray[2],responseDataArray[3]]
    }
    
    private func sha256(data: [UInt8]) -> [UInt8] {
